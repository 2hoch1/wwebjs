...
export interface InlineTocWithTitleProps
...
export function InlineTOCWithTitle({
  ...
  const classNameFn = (s: boolean): string => {
    ...
    return cn('not-prose rounded-lg border bg-fd-card text-fd-card-foreground', classNameStr)
  }

  return (
    <Collapsible {...props} className={classNameFn as any}>
