---
title: FAQ
description: Frequently asked questions about whatsapp-web.js, covering installation, authentication, messaging, groups, performance, errors, best practices, and legal considerations.
...
**A:** Yes, run multiple app instances with different auth strategies (RemoteAuth with database works best for this).
...
### Q: What's the recommended way to structure my app?
...
**A:** Unfortunately, WhatsApp bans are permanent. Use a different account and adjust your app's behavior.
