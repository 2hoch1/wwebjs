...
<Callout type="idea">
  Remember that you can always [fork the repo]() and make a [pull request]() if you want to add
  anything to the guide yourself! You can find a guide on how to contribute
  [here](https://github.com/wwebjs/wwebjs.dev/blob/candy/.github/CONTRIBUTING.md).
</Callout>
